...
Character.EMOTIONS = {
  neutral: (ch) => { gsap.to(ch.browL, { y: -2, rotation: -4, duration: .35 }); gsap.to(ch.browR, { y: -2, rotation: 4, duration: .35 }); gsap.to(ch.mouth, { width: 44, height: 12, borderRadius: 12, duration: .3 }); ch.mouthInterior(12); gsap.to('.cheek', { opacity: .35, duration: .3 }); gsap.to(ch.head, { rotation: 0, y: 0, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: 1, scaleX: 1, duration: .25 }); gsap.to([ch.pupilL, ch.pupilR], { y: 0, duration: .2 }); },
  happy: (ch) => { gsap.to(ch.browL, { y: -7, rotation: -10, duration: .3 }); gsap.to(ch.browR, { y: -7, rotation: 10, duration: .3 }); gsap.to(ch.mouth, { width: 68, height: 26, borderRadius: 14, duration: .3 }); gsap.to('.cheek', { opacity: .9, duration: .3 }); gsap.to(ch.head, { rotation: 1, y: -2, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .92, scaleX: 1.04, duration: .25 }); },
  excited: (ch) => { gsap.to(ch.browL, { y: -10, rotation: -14, duration: .25 }); gsap.to(ch.browR, { y: -10, rotation: 14, duration: .25 }); gsap.to(ch.mouth, { width: 78, height: 34, borderRadius: 16, duration: .25 }); gsap.to('.cheek', { opacity: 1, duration: .3 }); ch.windUp(.12); setTimeout(() => ch.popUp(8), 130); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .95, duration: .2 }); },
  sad: (ch) => { gsap.to(ch.browL, { y: 5, rotation: 16, duration: .3 }); gsap.to(ch.browR, { y: 5, rotation: -16, duration: .3 }); gsap.to(ch.mouth, { width: 44, height: 14, borderRadius: 8, duration: .3 }); gsap.to('.cheek', { opacity: .15, duration: .3 }); gsap.to(ch.head, { rotation: -2, y: 2, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .96, duration: .3 }); },
  angry: (ch) => { gsap.to(ch.browL, { y: 3, rotation: -20, duration: .2 }); gsap.to(ch.browR, { y: 3, rotation: 20, duration: .2 }); gsap.to(ch.mouth, { width: 54, height: 20, borderRadius: 4, duration: .25 }); gsap.to('.cheek', { opacity: .65, duration: .3 }); gsap.to(ch.head, { x: -2, duration: .05, yoyo: true, repeat: 6 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .9, scaleX: 1.08, duration: .2 }); },
  ...
  smug: (ch) => { gsap.to(ch.browL, { y: -3, rotation: -6, duration: .3 }); gsap.to(ch.browR, { y: 1, rotation: 2, duration: .3 }); gsap.to(ch.mouth, { width: 62, height: 14, borderRadius: 12, duration: .3 }); gsap.to('.cheek', { opacity: .55, duration: .3 }); gsap.to(ch.head, { rotation: 2, duration: .3 }); },
  shy: (ch) => { gsap.to(ch.browL, { y: -1, rotation: -2, duration: .3 }); gsap.to(ch.browR, { y: -1, rotation: 2, duration: .3 }); gsap.to(ch.mouth, { width: 36, height: 16, borderRadius: 10, duration: .3 }); gsap.to('.cheek', { opacity: 1, duration: .3 }); gsap.to(ch.head, { rotation: -3, y: 1, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .94, duration: .3 }); },
  sleepy: (ch) => { gsap.to(ch.browL, { y: 2, rotation: 0, duration: .3 }); gsap.to(ch.browR, { y: 2, rotation: 0, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .62, duration: .3 }); gsap.to(ch.mouth, { width: 34, height: 22, borderRadius: 50, duration: .3 }); gsap.to('.cheek', { opacity: .4, duration: .3 }); },
  suspicious: (ch) => { gsap.to(ch.browL, { y: -10, rotation: -10, duration: .25 }); gsap.to(ch.browR, { y: 2, rotation: 2, duration: .25 }); gsap.to([ch.pupilL, ch.pupilR], { x: 7, duration: .25 }); gsap.to(ch.mouth, { width: 50, height: 12, borderRadius: 8, duration: .25 }); gsap.to(ch.head, { rotation: 2, duration: .3 }); gsap.to('.cheek', { opacity: .3, duration: .3 }); },
  scared: (ch) => { gsap.to(ch.browL, { y: -12, rotation: 0, duration: .2 }); gsap.to(ch.browR, { y: -12, rotation: 0, duration: .2 }); gsap.to([ch.eyeL, ch.eyeR], { scale: 1.15, scaleY: 1.15, duration: .2 }); gsap.to(ch.mouth, { width: 36, height: 30, borderRadius: 50, duration: .2 }); gsap.to('.cheek', { opacity: .2, duration: .3 }); gsap.to(ch.head, { x: -2, duration: .06, yoyo: true, repeat: 5 }); setTimeout(() => gsap.to([ch.eyeL, ch.eyeR], { scale: 1, scaleY: 1, duration: .3 }), 600); },
  proud: (ch) => { gsap.to(ch.browL, { y: -6, rotation: -6, duration: .3 }); gsap.to(ch.browR, { y: -6, rotation: 6, duration: .3 }); gsap.to(ch.mouth, { width: 66, height: 18, borderRadius: 12, duration: .3 }); gsap.to('.cheek', { opacity: .6, duration: .3 }); gsap.to(ch.head, { rotation: -1, y: -3, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: 1, scaleX: 1, duration: .25 }); },
  bored: (ch) => { gsap.to(ch.browL, { y: 0, rotation: 0, duration: .3 }); gsap.to(ch.browR, { y: 0, rotation: 0, duration: .3 }); gsap.to([ch.eyeL, ch.eyeR], { scaleY: .7, duration: .3 }); gsap.to(ch.mouth, { width: 44, height: 10, borderRadius: 8, duration: .3 }); gsap.to(ch.head, { rotation: 4, y: 2, duration: .3 }); gsap.to('.cheek', { opacity: .25, duration: .3 }); },
};
